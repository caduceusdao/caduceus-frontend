...
export const CaduceusStackedLineChart = withChartCard(
  ({
    data,
    dataKey,
    colors,
...
export const CaduceusMultiLineChart = withChartCard(
  ({
    data,
    dataKey,
    colors,
...
export const CaduceusLineChart = withChartCard(
  ({
    data,
    dataKey,
    stroke,
...
export const CaduceusPieChart = withChartCard(
  ({
    data,
    dataKey,
    colors,

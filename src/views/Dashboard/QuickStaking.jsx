          ...
          {(!hasAllowance("ohm") && view === 0) || (!hasAllowance("sohm") && view === 1) ? (
            <Box className="help-text">
              <Typography variant="body1" className="stake-note" color="textSecondary">
                {view === 0 ? (
                  <>
                    <Trans>Please approve Caduceus to use your</Trans> <b>EXOD</b> <Trans>for staking</Trans>.
                  </>
                ) : (
                  <>
                    <Trans>Please approve Caduceus to use your</Trans> <b>sEXOD</b> <Trans>for unstaking</Trans>.
                  </>
                )}
              </Typography>
            </Box>
